"""Minimal real batched-continuous regression for route_c frozen semantic boundary behavior."""
...
SCHEMA_VERSION = "triscopellm/route-c-frozen-semantic-minimal-real-batched-continuous-regression/v1"
...
def _minimal_real_batched_continuous_suite(
    ...
    cases: list[dict[str, Any]] = [
        {
            "case_id": "real_batched_exec::bw01::recoverable::code_fence",
            "path_group": "recoverable_real_batched_continuous_regression",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_real_batched_continuous_regression_input": True,
            "real_continuous_window_id": "batch_window_01",
        ...
        {
            "case_id": "real_batched_exec::bw01::normal::csqa-pilot-002__control",
            "path_group": "normal_real_batched_continuous_regression_guardrail",
            "source_type": "real",
        ...
        {
            "case_id": "real_batched_exec::bw01::nonrecoverable::csqa-pilot-021__targeted",
            "path_group": "nonrecoverable_real_batched_continuous_regression_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_real_batched_continuous_regression_input": True,
            "real_continuous_window_id": "batch_window_01",
        ...
        {
            "case_id": "real_batched_exec::bw01::recoverable::code_fence_lang_tag",
            "path_group": "recoverable_real_batched_continuous_regression",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_real_batched_continuous_regression_input": True,
        ...
        {
            "case_id": "real_batched_exec::bw01::normal::csqa-pilot-021__control",
            "path_group": "normal_real_batched_continuous_regression_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_real_batched_continuous_regression_input": True,
        ...
        {
            "case_id": "real_batched_exec::bw01::nonrecoverable::code_fence_contract_broken",
            "path_group": "nonrecoverable_real_batched_continuous_regression_guardrail",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_real_batched_continuous_regression_input": True,
        ...
        {
            "case_id": "real_batched_exec::bw02::recoverable::code_fence",
            "path_group": "recoverable_real_batched_continuous_regression",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_real_batched_continuous_regression_input": True,
            "real_continuous_window_id": "batch_window_02",
            "real_continuous_position": 1,
        ...
        {
            "case_id": "real_batched_exec::bw02::normal::csqa-pilot-005__control",
            "path_group": "normal_real_batched_continuous_regression_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_real_batched_continuous_regression_input": True,
        ...
        {
            "case_id": "real_batched_exec::bw02::nonrecoverable::csqa-pilot-021__targeted",
            "path_group": "nonrecoverable_real_batched_continuous_regression_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_real_batched_continuous_regression_input": True,
        ...
        {
            "case_id": "real_batched_exec::bw02::recoverable::code_fence_lang_tag",
            "path_group": "recoverable_real_batched_continuous_regression",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_real_batched_continuous_regression_input": True,
        ...
        {
            "case_id": "real_batched_exec::bw02::normal::csqa-pilot-005__targeted",
            "path_group": "normal_real_batched_continuous_regression_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_real_batched_continuous_regression_input": True,
        ...
        {
            "case_id": "real_batched_exec::bw02::nonrecoverable::code_fence_contract_broken",
            "path_group": "nonrecoverable_real_batched_continuous_regression_guardrail",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_real_batched_continuous_regression_input": True,
...
def _materialize_real_batched_continuous_regression_inputs(
    cases: list[dict[str, Any]],
    real_raw_rows: list[dict[str, Any]],
        ...
        contract_metadata.update(
            {
                ...
                "contract_variant": f"real_batched_exec_regression_{index:02d}",
                "query_answer_key": str(case["query_answer_key"]),
                "label_source": "minimal_real_batched_continuous_regression_validation",
                "label_scope": "benchmark_truth_leaning_supervision_proxy",
            }
        )
        metadata["contract_metadata"] = contract_metadata
        metadata["real_batched_continuous_regression_validation_reference"] = {
            ...
            "is_real_batched_continuous_regression_input": bool(case["is_real_batched_continuous_regression_input"]),
        }

        labeled_rows.append(
            {
                **template,
                "sample_id": f"real_batched_exec_regression_{index:02d}__{case['case_id'].split('::')[-1]}",
    ...
    dataset_input_path = execution_root_dir / "execution_inputs" / "minimal_real_batched_continuous_regression_labeled_raw_results.jsonl"
    fusion_path = execution_root_dir / "execution_inputs" / "minimal_real_batched_continuous_regression_fusion_dataset.jsonl"
    ...
    write_json(execution_root_dir / "execution_inputs" / "real_batched_continuous_regression_input_manifest.json", manifest)
    return manifest
...
def _evaluate_records(cases: list[dict[str, Any]], health_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for index, case in enumerate(cases):
        ...
        if case["path_group"] == "recoverable_real_batched_continuous_regression" and current_handoff != "pass_formatted_to_parser":
            mismatch_type = "recoverable_real_continuous_regression"
        elif case["path_group"] == "normal_real_batched_continuous_regression_guardrail" and current_handoff != "pass_raw_to_parser":
            mismatch_type = "normal_real_continuous_damage"
        elif (
            case["path_group"] == "nonrecoverable_real_batched_continuous_regression_guardrail"
...
def _summary(
    ...
    recoverable_records = [r for r in records if r["path_group"] == "recoverable_real_batched_continuous_regression"]
    normal_records = [r for r in records if r["path_group"] == "normal_real_batched_continuous_regression_guardrail"]
    nonrecoverable_records = [
        r for r in records if r["path_group"] == "nonrecoverable_real_batched_continuous_regression_guardrail"
    ]
    ...
    focused_validation_answers = {
        "recoverable_boundary_stable_on_real_batched_continuous_regression": int(
            mismatch_counts.get("recoverable_real_continuous_regression", 0)
        )
        == 0,
        "code_fence_like_recoverable_handoff_stable_on_real_batched_continuous_regression": int(
            mismatch_counts.get("recoverable_real_continuous_regression", 0)
        )
        == 0
        and all(r["current_handoff"] == "pass_formatted_to_parser" for r in code_fence_records),
        "normal_real_batched_continuous_regression_cases_all_pass": int(
            mismatch_counts.get("normal_real_continuous_damage", 0)
        )
        == 0,
        "nonrecoverable_real_batched_continuous_regression_cases_all_blocked": int(
...
def _report(summary: dict[str, Any], records: list[dict[str, Any]]) -> str:
    lines: list[str] = []
    lines.append("# Route-C Frozen Semantic Minimal Real Batched Continuous Regression Report")
    lines.append("")
    lines.append("## Real-Batched-Continuous Summary")
    ...
    lines.append("")
    lines.append("## Real-Batched-Continuous Window Consistency")
    ...
    lines.append(
        "- recoverable formatting boundary on real-batched-continuous regression stable: "
        + str(answers["recoverable_boundary_stable_on_real_batched_continuous_regression"])
    )
    lines.append(
        "- code-fence-like recoverable handoff on real-batched-continuous regression stable: "
        + str(answers["code_fence_like_recoverable_handoff_stable_on_real_batched_continuous_regression"])
    )
    lines.append(
        "- normal real-batched-continuous cases all pass: "
        + str(answers["normal_real_batched_continuous_regression_cases_all_pass"])
    )
    lines.append(
        "- nonrecoverable real-batched-continuous cases all blocked: "
        + str(answers["nonrecoverable_real_batched_continuous_regression_cases_all_blocked"])
    )
    lines.append(
    ...
    lines.append("")
    lines.append("## Minimal Collateral Real-Batched-Continuous Analysis")
...
def build_route_c_frozen_semantic_minimal_real_batched_continuous_regression(
    real_run_dir: Path,
    stage_148_dir: Path,
    stage_149_dir: Path,
    stage_150_dir: Path,
    ...
    cases = _minimal_real_batched_continuous_suite(
    ...
    suite = {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "suite_name": "route_c_frozen_semantic_minimal_real_batched_continuous_regression_v1",
        "case_count": len(cases),
        "real_continuous_window_ids": sorted({str(case["real_continuous_window_id"]) for case in cases}),
        "real_prompt_anchor_ids": sorted({str(case["real_prompt_anchor_id"]) for case in cases}),
        "group_counts": dict(Counter(case["path_group"] for case in cases)),
    ...
    rules = {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "recoverable_real_batched_continuous_regression_criteria": [
        ...
        "normal_real_batched_continuous_regression_criteria": [
        ...
        "nonrecoverable_real_batched_continuous_regression_criteria": [
        ...
        "real_batched_continuous_regression_consistency_criteria": [
            "parser/gate/label-health/handoff semantics remain coherent",
            "impact scope stays local to recoverable boundary",
            "no new path-level drift or gate/logistic/health anomaly in real batched continuous chain",
        ],
    }

    execution_root_dir = output_dir / "minimal_real_batched_continuous_regression_root"
    input_manifest = _materialize_real_batched_continuous_regression_inputs(
        cases=cases,
        real_raw_rows=real_raw_rows,
    ...
    dataset_result = build_benchmark_truth_leaning_dataset(
        ...
        / "execution_inputs"
        / "minimal_real_batched_continuous_regression_fusion_dataset.jsonl",
        labeled_illumination_raw_results_path=execution_root_dir
        / "execution_inputs"
        / "minimal_real_batched_continuous_regression_labeled_raw_results.jsonl",
        output_dir=dataset_dir,
        fusion_profile="route_c_frozen_semantic_minimal_real_batched_continuous_regression",
        run_id="route_c_frozen_semantic_minimal_real_batched_continuous_regression",
    ...
    write_json(output_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_suite.json", suite)
    write_json(output_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_rules.json", rules)
    write_json(output_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_summary.json", summary)
    write_jsonl(output_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_details.jsonl", records)
    (output_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_report.md").write_text(report, encoding="utf-8")
    ...
    write_json(
        output_dir / "config_snapshot.json",
        {
            ...
            "input_manifest_path": str(
                (execution_root_dir / "execution_inputs" / "real_batched_continuous_regression_input_manifest.json").resolve()
            ),
    ...
    return {
        ...
        "summary": summary,
        "output_paths": {
            "suite": str((output_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_suite.json").resolve()),
            "rules": str((output_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_rules.json").resolve()),
            "summary": str((output_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_summary.json").resolve()),
            "details": str((output_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_details.jsonl").resolve()),
            "report": str((output_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_report.md").resolve()),
