"""Bootstrap the next-axis-after-v6 real-experiment matrix."""
...
SCHEMA_VERSION = "triscopellm/next-axis-after-v6-matrix-bootstrap/v1"
...
def build_next_axis_after_v6_matrix_bootstrap(
    ...
    if recommendation.get("recommended_next_step") != "bootstrap_next_axis_after_v6_matrix":
        raise ValueError("085 expects recommendation to request next-axis-after-v6 bootstrap.")

    matrix_plan = {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "chosen_next_step": "bootstrap_next_axis_after_v6_matrix",
    ...
    matrix_definition = {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "matrix_name": "next_axis_after_v6_real_experiment_matrix_v7",
        ...
        "fusion_mode": "stress_refined_fusion_support_isolation_contract",
        "output_expectations": [
            "route_b_summary",
            "route_c_summary",
            "fusion_summary",
        ...
        "expansion_notes": [
            "This next-axis-after-v6 matrix keeps dataset/model fixed and isolates support-retained refined fusion signal.",
            "The goal is to test whether the refined support-surviving signal still carries information once its support-specific residue is explicitly ablated.",
        ],
    }
    readiness = {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "next_axis_after_v6_matrix_ready": True,
    ...
    write_json(output_dir / "next_axis_after_v6_matrix_plan.json", matrix_plan)
    write_json(output_dir / "next_axis_after_v6_matrix_definition.json", matrix_definition)
    write_json(output_dir / "next_axis_after_v6_matrix_readiness_summary.json", readiness)

    materialized_dir = output_dir / "materialized_next_axis_after_v6_matrix"
    ...
    write_json(output_dir / "next_axis_after_v6_input_contract.json", input_contract)
    write_json(output_dir / "next_axis_after_v6_bootstrap_summary.json", bootstrap_summary)
    return {
        "summary": bootstrap_summary,
        "output_paths": {
            "plan": str((output_dir / "next_axis_after_v6_matrix_plan.json").resolve()),
            "definition": str((output_dir / "next_axis_after_v6_matrix_definition.json").resolve()),
            "readiness": str((output_dir / "next_axis_after_v6_matrix_readiness_summary.json").resolve()),
            "contract": str((output_dir / "next_axis_after_v6_input_contract.json").resolve()),
            "summary": str((output_dir / "next_axis_after_v6_bootstrap_summary.json").resolve()),
        },
    }
