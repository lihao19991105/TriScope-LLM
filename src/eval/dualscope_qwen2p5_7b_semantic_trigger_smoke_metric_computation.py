"""Compute bounded Qwen2.5-7B semantic trigger smoke metrics from real artifacts."""
...
SCHEMA_VERSION = "dualscope/qwen2p5-7b-semantic-trigger-smoke-metric-computation/v1"
TASK_ID = "dualscope-qwen2p5-7b-semantic-trigger-smoke-metric-computation"
FINAL_VALIDATED = "Qwen2.5-7B semantic trigger smoke metrics validated"
FINAL_PARTIAL = "Partially validated"
FINAL_NOT_VALIDATED = "Not validated"
NEXT_RESULT_PACKAGE = "dualscope-qwen2p5-7b-semantic-trigger-smoke-result-package"

RESPONSE_ROW_CANDIDATES = (
    "semantic_trigger_smoke_responses.jsonl",
    "qwen2p5_7b_semantic_trigger_smoke_response_generation_rows.jsonl",
    "qwen2p5_7b_semantic_trigger_smoke_responses.jsonl",
)
...
def _compute_detection_metrics(rows: list[dict[str, Any]], threshold: float) -> dict[str, Any]:
    ...
    return {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "metric_scope": "bounded_semantic_trigger_smoke_label_score_real_response_aligned",
        "row_count": len(rows),
...
def _compute_asr(rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "metric_scope": "bounded_semantic_trigger_smoke_real_response_asr",
        "eligible_row_count": len(eligible),
...
def _compute_clean_utility(rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "metric_scope": "bounded_semantic_trigger_smoke_real_response_clean_utility",
        "eligible_row_count": len(eligible),
...
def build_qwen2p5_7b_semantic_trigger_smoke_metric_computation(
    *,
    labeled_pairs: Path,
    response_dir: Path,
    score_dir: Path,
    ...
    # This task validates computation of available semantic-smoke metrics. Clean
    ...
    recommendation = NEXT_RESULT_PACKAGE if final_verdict in {FINAL_VALIDATED, FINAL_PARTIAL} else "dualscope-qwen2p5-7b-semantic-trigger-smoke-metric-blocker-closure"
    ...
    verdict = {
        ...
        "final_verdict": final_verdict,
        "recommended_next_step": recommendation,
        "single_verdict_policy": "one_of_qwen2p5_7b_semantic_trigger_smoke_metrics_validated__partially_validated__not_validated",
    }
