"""Build clean / poisoned-triggered labeled pairs for the DualScope first slice."""
        ...
        rows.append(
            {
                **base_fields,
                ...
                "prompt": insert_trigger(clean_prompt, trigger_text),
...
def build_clean_poisoned_labeled_slice(
    ...
    labeled_rows = build_labeled_rows(source_rows, trigger_text, target_text, seed)
