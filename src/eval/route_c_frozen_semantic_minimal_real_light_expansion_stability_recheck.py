"""Stage-158 minimal real light-expansion stability recheck under frozen semantics and gate."""
...
SCHEMA_VERSION = "triscopellm/route-c-frozen-semantic-minimal-real-light-expansion-stability-recheck/v1"
FILE_PREFIX = "route_c_frozen_semantic_minimal_real_light_expansion_stability_recheck"


def build_route_c_frozen_semantic_minimal_real_light_expansion_stability_recheck(
    *,
    real_run_dir: Path,
    stage_155_dir: Path,
    stage_156_dir: Path,
    ...
    window_specs = [
        {
            ...
            "entries": [
                ...
                },
                {
                    ...
                    "note": "real nonrecoverable anchor from illumination_0000",
                },
                {
                    "path_kind": "recoverable",
            ...
            "entries": [
                {
                    ...
                    "anchor_prompt_id": "illumination_0002",
                    "response_variant": "code_fence",
                    "case_tail": "code_fence_recheck",
                    "note": "additional recoverable recheck wrapper from illumination_0002",
                },
                {
                    "path_kind": "normal",
                    "anchor_prompt_id": "illumination_0003",
                    "response_variant": "raw",
                    "case_tail": "csqa-pilot-005__control_recheck",
                    "note": "additional real normal recheck case from illumination_0003",
                },
                {
                    "path_kind": "nonrecoverable",
                    "anchor_prompt_id": "illumination_0000",
                    "response_variant": "raw",
                    "case_tail": "csqa-pilot-021__targeted_recheck",
                    "note": "additional real nonrecoverable recheck case from illumination_0000",
                },
                {
                    "path_kind": "recoverable",
                    "anchor_prompt_id": "illumination_0004",
                    "response_variant": "code_fence_lang_tag",
                    "case_tail": "code_fence_lang_tag_recheck",
                    "note": "additional recoverable language-tag recheck from illumination_0004",
                },
                {
                    "path_kind": "normal",
                    "anchor_prompt_id": "illumination_0005",
                    "response_variant": "raw",
                    "case_tail": "csqa-pilot-005__targeted_recheck",
                    "note": "additional real normal recheck case from illumination_0005",
                },
            ],
        },
    ]
    ...
    return run_light_expansion_stage(
        ...
        suite_name="route_c_frozen_semantic_minimal_real_light_expansion_stability_recheck_v1",
        report_title="Route-C Frozen Semantic Minimal Real Light Expansion Stability Recheck Report",
        stage_token="minimal_real_light_expansion_stability_recheck_exec",
        case_prefix="real_light_expansion_recheck_exec",
        required_prompt_ids=[
            "illumination_0000",
            "illumination_0001",
            "illumination_0002",
        ...
        path_group_by_kind={
            "recoverable": "recoverable_real_light_expansion_stability_recheck",
            "normal": "normal_real_light_expansion_stability_recheck_guardrail",
            "nonrecoverable": "nonrecoverable_real_light_expansion_stability_recheck_guardrail",
        },
        rules_payload={
            "recoverable_real_light_expansion_stability_recheck_criteria": [
            ...
            "normal_real_light_expansion_stability_recheck_criteria": [
                "normal cases must keep pass_raw_to_parser",
                "normal cases must not gain new collateral false blocks",
            ],
            "nonrecoverable_real_light_expansion_stability_recheck_criteria": [
            ...
            "real_light_expansion_stability_recheck_consistency_criteria": [
        ...
        previous_reference_details_path=stage_157_dir / "route_c_frozen_semantic_minimal_real_light_expansion_details.jsonl",
        previous_reference_prefix="real_light_expansion_exec",
