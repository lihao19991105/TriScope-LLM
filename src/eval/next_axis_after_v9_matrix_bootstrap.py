"""Bootstrap the next-axis-after-v9 real-experiment matrix."""
...
SCHEMA_VERSION = "triscopellm/next-axis-after-v9-matrix-bootstrap/v1"
...
def build_next_axis_after_v9_matrix_bootstrap(
    ...
    if recommendation.get("recommended_next_step") != "bootstrap_next_axis_after_v9_matrix":
        raise ValueError("097 expects recommendation to request next-axis-after-v9 bootstrap.")

    matrix_plan = {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "chosen_next_step": "bootstrap_next_axis_after_v9_matrix",
    ...
    matrix_definition = {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "matrix_name": "next_axis_after_v9_real_experiment_matrix_v10",
        ...
        "fusion_mode": "stress_refined_fusion_support_floor_stress_contract",
        "output_expectations": [
            "route_b_summary",
            "route_c_summary",
            "fusion_summary",
        ...
        "expansion_notes": [
            "This next-axis-after-v9 matrix keeps dataset/model fixed and stresses the explicit support-ablation floor directly.",
            "The goal is to test whether the explicit support floor remains stable once it is subjected to direct floor stress.",
        ],
    }
    readiness = {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "next_axis_after_v9_matrix_ready": True,
    ...
    write_json(output_dir / "next_axis_after_v9_matrix_plan.json", matrix_plan)
    write_json(output_dir / "next_axis_after_v9_matrix_definition.json", matrix_definition)
    write_json(output_dir / "next_axis_after_v9_matrix_readiness_summary.json", readiness)

    materialized_dir = output_dir / "materialized_next_axis_after_v9_matrix"
    ...
    write_json(output_dir / "next_axis_after_v9_input_contract.json", input_contract)
    write_json(output_dir / "next_axis_after_v9_bootstrap_summary.json", bootstrap_summary)
    return {
        "summary": bootstrap_summary,
        "output_paths": {
            "plan": str((output_dir / "next_axis_after_v9_matrix_plan.json").resolve()),
            "definition": str((output_dir / "next_axis_after_v9_matrix_definition.json").resolve()),
            "readiness": str((output_dir / "next_axis_after_v9_matrix_readiness_summary.json").resolve()),
            "contract": str((output_dir / "next_axis_after_v9_input_contract.json").resolve()),
            "summary": str((output_dir / "next_axis_after_v9_bootstrap_summary.json").resolve()),
        },
    }
