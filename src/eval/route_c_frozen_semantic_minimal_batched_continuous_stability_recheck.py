"""Minimal batched-continuous stability recheck for route_c frozen semantic boundary behavior."""
...
SCHEMA_VERSION = "triscopellm/route-c-frozen-semantic-minimal-batched-continuous-stability-recheck/v1"
...
def _load_154_details(stage_154_dir: Path) -> list[dict[str, Any]]:
    return load_jsonl(
        _required_file(
            stage_154_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_details.jsonl"
        )
    )
...
def _minimal_batched_continuous_stability_recheck_suite(
    ...
    stage_154_reference_by_case: dict[str, dict[str, Any]],
) -> list[dict[str, Any]]:
    ...
    required_samples = [
        ...
        "csqa-pilot-005__control",
        "csqa-pilot-002__targeted",
        "csqa-pilot-005__targeted",
    ]
    ...
    normal_anchor_three = by_prompt["illumination_0003"]
    normal_anchor_four = by_prompt["illumination_0004"]
    normal_anchor_five = by_prompt["illumination_0005"]

    recoverable_raw_one = str(normal_anchor_one["response_text"])
    recoverable_raw_two = str(normal_anchor_two["response_text"])
    recoverable_raw_three = str(normal_anchor_three["response_text"])
    recoverable_raw_four = str(normal_anchor_four["response_text"])
    nonrecoverable_raw = str(nonrecoverable_anchor["response_text"])

    cases: list[dict[str, Any]] = [
        {
            "case_id": "batched_recheck_exec::bw01::recoverable::code_fence",
            "path_group": "recoverable_batched_continuous_stability_recheck",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_batched_continuous_stability_recheck_input": True,
            "batched_continuous_recheck_window_id": "batch_window_01",
            "batched_continuous_recheck_position": 1,
        ...
        {
            "case_id": "batched_recheck_exec::bw01::normal::csqa-pilot-002__control",
            "path_group": "normal_batched_continuous_stability_recheck_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_batched_continuous_stability_recheck_input": True,
            "batched_continuous_recheck_window_id": "batch_window_01",
            "batched_continuous_recheck_position": 2,
            "real_prompt_anchor_id": "illumination_0001",
            "real_execution_anchor_sample_id": str(normal_anchor_one["sample_id"]),
        ...
        {
            "case_id": "batched_recheck_exec::bw01::nonrecoverable::csqa-pilot-021__targeted",
            "path_group": "nonrecoverable_batched_continuous_stability_recheck_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_batched_continuous_stability_recheck_input": True,
            "batched_continuous_recheck_window_id": "batch_window_01",
            "batched_continuous_recheck_position": 3,
        ...
        {
            "case_id": "batched_recheck_exec::bw01::recoverable::code_fence_lang_tag",
            "path_group": "recoverable_batched_continuous_stability_recheck",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_batched_continuous_stability_recheck_input": True,
            "batched_continuous_recheck_window_id": "batch_window_01",
            "batched_continuous_recheck_position": 4,
        ...
        {
            "case_id": "batched_recheck_exec::bw01::normal::csqa-pilot-021__control",
            "path_group": "normal_batched_continuous_stability_recheck_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_batched_continuous_stability_recheck_input": True,
            "batched_continuous_recheck_window_id": "batch_window_01",
            "batched_continuous_recheck_position": 5,
            "real_prompt_anchor_id": "illumination_0002",
            "real_execution_anchor_sample_id": str(normal_anchor_two["sample_id"]),
        ...
        {
            "case_id": "batched_recheck_exec::bw01::nonrecoverable::code_fence_contract_broken",
            "path_group": "nonrecoverable_batched_continuous_stability_recheck_guardrail",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_batched_continuous_stability_recheck_input": True,
            "batched_continuous_recheck_window_id": "batch_window_01",
            "batched_continuous_recheck_position": 6,
            "real_prompt_anchor_id": "illumination_0000",
            "real_execution_anchor_sample_id": str(nonrecoverable_anchor["sample_id"]),
            "raw_response": f"```text\n{nonrecoverable_raw}\n```",
            "query_answer_key": _query_answer_key(nonrecoverable_anchor),
        ...
        {
            "case_id": "batched_recheck_exec::bw02::recoverable::code_fence",
            "path_group": "recoverable_batched_continuous_stability_recheck",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_batched_continuous_stability_recheck_input": True,
            "batched_continuous_recheck_window_id": "batch_window_02",
            "batched_continuous_recheck_position": 1,
            "real_prompt_anchor_id": "illumination_0003",
            "real_execution_anchor_sample_id": str(normal_anchor_three["sample_id"]),
            "raw_response": f"```{recoverable_raw_three}```",
            "query_answer_key": _query_answer_key(normal_anchor_three),
            "expected_handoff": "pass_formatted_to_parser",
            "expected_category": "recoverable_formatting_issue",
            "expected_recoverability": "recoverable",
            "stage_150_reference_case_id": "focused::controlled_recoverable::code_fence",
            ...
            "code_fence_like": True,
            "case_note": "batch-02 recoverable code-fence wrapper derived from real prompt anchor illumination_0003",
        },
        {
            "case_id": "batched_recheck_exec::bw02::normal::csqa-pilot-005__control",
            "path_group": "normal_batched_continuous_stability_recheck_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_batched_continuous_stability_recheck_input": True,
            ...
            "real_prompt_anchor_id": "illumination_0003",
            "real_execution_anchor_sample_id": str(normal_anchor_three["sample_id"]),
            "raw_response": str(normal_anchor_three["response_text"]),
            "query_answer_key": _query_answer_key(normal_anchor_three),
            "expected_handoff": "pass_raw_to_parser",
            "expected_category": "parser_reachable",
            "expected_recoverability": "not_needed",
            ...
            "stage_150_reference_handoff": None,
            "stage_150_reference_category": None,
            "stage_151_reference_case_id": None,
            "stage_151_reference_handoff": None,
            "stage_151_reference_category": None,
            "stage_152_reference_case_id": None,
            "stage_152_reference_handoff": None,
            "stage_152_reference_category": None,
            "code_fence_like": False,
            "case_note": "batch-02 real normal guardrail case from prompt anchor illumination_0003",
        },
        {
            "case_id": "batched_recheck_exec::bw02::nonrecoverable::csqa-pilot-021__targeted",
            "path_group": "nonrecoverable_batched_continuous_stability_recheck_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_batched_continuous_stability_recheck_input": True,
            ...
            "code_fence_like": False,
            "case_note": "batch-02 reuses the only stable nonrecoverable real anchor illumination_0000",
        },
        {
            "case_id": "batched_recheck_exec::bw02::recoverable::code_fence_lang_tag",
            "path_group": "recoverable_batched_continuous_stability_recheck",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_batched_continuous_stability_recheck_input": True,
            "batched_continuous_recheck_window_id": "batch_window_02",
            "batched_continuous_recheck_position": 4,
            "real_prompt_anchor_id": "illumination_0004",
            "real_execution_anchor_sample_id": str(normal_anchor_four["sample_id"]),
            "raw_response": f"```text\n{recoverable_raw_four}\n```",
            "query_answer_key": _query_answer_key(normal_anchor_four),
            "expected_handoff": "pass_formatted_to_parser",
            "expected_category": "recoverable_formatting_issue",
            "expected_recoverability": "recoverable",
            "stage_150_reference_case_id": "focused::new_recoverable::code_fence_lang_tag",
            ...
            "code_fence_like": True,
            "case_note": "batch-02 language-tag recoverable wrapper derived from real prompt anchor illumination_0004",
        },
        {
            "case_id": "batched_recheck_exec::bw02::normal::csqa-pilot-005__targeted",
            "path_group": "normal_batched_continuous_stability_recheck_guardrail",
            "source_type": "real",
            "is_real_execution_input": True,
            "is_batched_continuous_stability_recheck_input": True,
            "batched_continuous_recheck_window_id": "batch_window_02",
            "batched_continuous_recheck_position": 5,
            "real_prompt_anchor_id": "illumination_0005",
            "real_execution_anchor_sample_id": str(normal_anchor_five["sample_id"]),
            "raw_response": str(normal_anchor_five["response_text"]),
            "query_answer_key": _query_answer_key(normal_anchor_five),
            "expected_handoff": "pass_raw_to_parser",
            "expected_category": "parser_reachable",
            "expected_recoverability": "not_needed",
            "stage_150_reference_case_id": None,
            ...
            "stage_152_reference_category": None,
            "code_fence_like": False,
            "case_note": "batch-02 real normal guardrail case from prompt anchor illumination_0005",
        },
        {
            "case_id": "batched_recheck_exec::bw02::nonrecoverable::code_fence_contract_broken",
            "path_group": "nonrecoverable_batched_continuous_stability_recheck_guardrail",
            "source_type": "controlled-format-variant-from-real",
            "is_real_execution_input": False,
            "is_batched_continuous_stability_recheck_input": True,
            ...
            "code_fence_like": True,
            "case_note": "batch-02 near-boundary nonrecoverable code-fence wrapper from illumination_0000",
        },
    ]
    for case in cases:
        stage_154_case_id = str(case["case_id"]).replace("batched_recheck_exec", "real_batched_exec")
        stage_154_row = stage_154_reference_by_case[stage_154_case_id]
        case["stage_154_reference_case_id"] = stage_154_case_id
        case["stage_154_reference_handoff"] = stage_154_row["current_handoff"]
        case["stage_154_reference_category"] = stage_154_row["current_category"]
...
def _materialize_batched_continuous_stability_recheck_inputs(
    cases: list[dict[str, Any]],
    real_raw_rows: list[dict[str, Any]],
        ...
        contract_metadata.update(
            {
                ...
                "contract_variant": f"batched_recheck_exec_{index:02d}",
                "query_answer_key": str(case["query_answer_key"]),
                "label_source": "minimal_batched_continuous_stability_recheck_validation",
                "label_scope": "benchmark_truth_leaning_supervision_proxy",
            }
        )
        metadata["contract_metadata"] = contract_metadata
        metadata["batched_continuous_stability_recheck_validation_reference"] = {
            "case_id": case["case_id"],
            "path_group": case["path_group"],
            "source_type": case["source_type"],
            "batched_continuous_recheck_window_id": case["batched_continuous_recheck_window_id"],
            "batched_continuous_recheck_position": int(case["batched_continuous_recheck_position"]),
            "real_prompt_anchor_id": case["real_prompt_anchor_id"],
            "is_real_execution_input": bool(case["is_real_execution_input"]),
            "is_batched_continuous_stability_recheck_input": bool(case["is_batched_continuous_stability_recheck_input"]),
        }

        labeled_rows.append(
            {
                **template,
                "sample_id": f"batched_recheck_exec_{index:02d}__{case['case_id'].split('::')[-1]}",
    ...
    dataset_input_path = execution_root_dir / "execution_inputs" / "minimal_batched_continuous_stability_recheck_labeled_raw_results.jsonl"
    fusion_path = execution_root_dir / "execution_inputs" / "minimal_batched_continuous_stability_recheck_fusion_dataset.jsonl"
    ...
    manifest = {
        ...
        "batched_continuous_recheck_window_ids": sorted({str(case["batched_continuous_recheck_window_id"]) for case in cases}),
    ...
    write_json(execution_root_dir / "execution_inputs" / "batched_continuous_stability_recheck_input_manifest.json", manifest)
    return manifest
...
def _evaluate_records(cases: list[dict[str, Any]], health_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for index, case in enumerate(cases):
        ...
        has_stage_154_reference = bool(case["stage_154_reference_case_id"])
        ...
        match_stage_154_reference = (
            current_handoff == case["stage_154_reference_handoff"]
            and current_category == case["stage_154_reference_category"]
            if has_stage_154_reference
            else None
        )
        ...
        if case["path_group"] == "recoverable_batched_continuous_stability_recheck" and current_handoff != "pass_formatted_to_parser":
            mismatch_type = "recoverable_batched_continuous_stability_recheck_regression"
        elif case["path_group"] == "normal_batched_continuous_stability_recheck_guardrail" and current_handoff != "pass_raw_to_parser":
            mismatch_type = "normal_batched_continuous_stability_recheck_damage"
        elif (
            case["path_group"] == "nonrecoverable_batched_continuous_stability_recheck_guardrail"
            and current_handoff != "degeneration_blocked"
        ):
            mismatch_type = "nonrecoverable_batched_continuous_stability_recheck_leak"
        elif not match_expected:
            mismatch_type = "expected_behavior_drift"
        elif has_stage_154_reference and match_stage_154_reference is False:
            mismatch_type = "stage154_reference_drift"
        ...
        records.append(
            {
                ...
                **case,
                ...
                "match_stage_154_reference": match_stage_154_reference,
...
def _batched_continuous_recheck_window_summary(records: list[dict[str, Any]]) -> list[dict[str, Any]]:
    by_window: dict[str, list[dict[str, Any]]] = defaultdict(list)
    for row in records:
        by_window[str(row["batched_continuous_recheck_window_id"])].append(row)

    output: list[dict[str, Any]] = []
    for window_id in sorted(by_window):
        rows = sorted(by_window[window_id], key=lambda item: int(item["batched_continuous_recheck_position"]))
...
def _summary(
    ...
    recoverable_records = [r for r in records if r["path_group"] == "recoverable_batched_continuous_stability_recheck"]
    normal_records = [r for r in records if r["path_group"] == "normal_batched_continuous_stability_recheck_guardrail"]
    nonrecoverable_records = [
        r for r in records if r["path_group"] == "nonrecoverable_batched_continuous_stability_recheck_guardrail"
    ]
    ...
    stage_154_anchored_records = [r for r in records if bool(r["stage_154_reference_case_id"])]

    window_summary = _batched_continuous_recheck_window_summary(records)
    ...
    focused_validation_answers = {
        "recoverable_boundary_stable_on_batched_continuous_stability_recheck": int(
            mismatch_counts.get("recoverable_batched_continuous_stability_recheck_regression", 0)
        )
        == 0,
        "code_fence_like_recoverable_handoff_stable_on_batched_continuous_stability_recheck": int(
            mismatch_counts.get("recoverable_batched_continuous_stability_recheck_regression", 0)
        )
        == 0
        and all(r["current_handoff"] == "pass_formatted_to_parser" for r in code_fence_records),
        "normal_batched_continuous_stability_recheck_cases_all_pass": int(
            mismatch_counts.get("normal_batched_continuous_stability_recheck_damage", 0)
        )
        == 0,
        "nonrecoverable_batched_continuous_stability_recheck_cases_all_blocked": int(
            mismatch_counts.get("nonrecoverable_batched_continuous_stability_recheck_leak", 0)
        )
        == 0,
        "parser_gate_health_consistent_with_152_153_154": int(mismatch_counts.get("stage150_reference_drift", 0)) == 0
        and int(mismatch_counts.get("stage151_reference_drift", 0)) == 0
        and int(mismatch_counts.get("stage152_reference_drift", 0)) == 0
        and int(mismatch_counts.get("stage154_reference_drift", 0)) == 0
        ...
        "impact_scope_limited_to_recoverable_boundary": int(
            mismatch_counts.get("normal_batched_continuous_stability_recheck_damage", 0)
        )
        == 0
        and int(mismatch_counts.get("nonrecoverable_batched_continuous_stability_recheck_leak", 0)) == 0,
    }
    ...
    return {
        ...
        "batched_continuous_recheck_window_count": len(window_summary),
        "batched_continuous_recheck_window_summary": window_summary,
        ...
        "recoverable_batched_continuous_stability_recheck_regression_count": int(
            mismatch_counts.get("recoverable_batched_continuous_stability_recheck_regression", 0)
        ),
        "normal_batched_continuous_stability_recheck_damage_count": int(
            mismatch_counts.get("normal_batched_continuous_stability_recheck_damage", 0)
        ),
        "nonrecoverable_batched_continuous_stability_recheck_leak_count": int(
            mismatch_counts.get("nonrecoverable_batched_continuous_stability_recheck_leak", 0)
        ),
        ...
        "stage154_reference_drift_count": int(mismatch_counts.get("stage154_reference_drift", 0)),
        ...
        "stage154_anchored_case_count": len(stage_154_anchored_records),
        "stage154_anchored_cases_match_frozen_reference": all(
            bool(r["match_stage_154_reference"]) for r in stage_154_anchored_records
        ),
        ...
        "minimal_collateral_batched_continuous_stability_recheck_analysis": {
            "new_false_block_count": int(mismatch_counts.get("normal_batched_continuous_stability_recheck_damage", 0)),
            "new_leak_count": int(mismatch_counts.get("nonrecoverable_batched_continuous_stability_recheck_leak", 0)),
            "regression_correct_but_stability_recheck_unstable": bool(
                int(mismatch_counts.get("stage154_reference_drift", 0)) > 0
                or int(mismatch_counts.get("stage152_reference_drift", 0)) > 0
                or int(mismatch_counts.get("stage151_reference_drift", 0)) > 0
                or int(mismatch_counts.get("stage150_reference_drift", 0)) > 0
...
def _report(summary: dict[str, Any], records: list[dict[str, Any]]) -> str:
    lines: list[str] = []
    lines.append("# Route-C Frozen Semantic Minimal Batched Continuous Stability Recheck Report")
    lines.append("")
    lines.append("## Batched-Continuous-Recheck Summary")
    lines.append(
        f"- recoverable_batched_continuous_stability_recheck_pass_rate: {summary['recoverable_batched_continuous_stability_recheck_pass_rate']}"
    )
    lines.append(f"- code_fence_recoverable_pass_rate: {summary['code_fence_recoverable_pass_rate']}")
    lines.append(
        f"- normal_batched_continuous_stability_recheck_pass_rate: {summary['normal_batched_continuous_stability_recheck_pass_rate']}"
    )
    lines.append(
        f"- nonrecoverable_batched_continuous_stability_recheck_block_rate: {summary['nonrecoverable_batched_continuous_stability_recheck_block_rate']}"
    )
    ...
    lines.append(f"- stage154_anchored_cases_match_frozen_reference: {summary['stage154_anchored_cases_match_frozen_reference']}")
    lines.append("")
    lines.append("## Batched-Continuous-Recheck Window Consistency")
    for window in summary["batched_continuous_recheck_window_summary"]:
        lines.append(
            "- "
    ...
    lines.append(
        "- recoverable formatting boundary on batched-continuous-recheck regression stable: "
        + str(answers["recoverable_boundary_stable_on_batched_continuous_stability_recheck"])
    )
    lines.append(
        "- code-fence-like recoverable handoff on batched-continuous-recheck regression stable: "
        + str(answers["code_fence_like_recoverable_handoff_stable_on_batched_continuous_stability_recheck"])
    )
    lines.append(
        "- normal batched-continuous-recheck cases all pass: "
        + str(answers["normal_batched_continuous_stability_recheck_cases_all_pass"])
    )
    lines.append(
        "- nonrecoverable batched-continuous-recheck cases all blocked: "
        + str(answers["nonrecoverable_batched_continuous_stability_recheck_cases_all_blocked"])
    )
    lines.append(
        "- parser/gate/health consistency with 152/153/154 kept: "
        + str(answers["parser_gate_health_consistent_with_152_153_154"])
    )
    lines.append(
    ...
    lines.append("")
    lines.append("## Minimal Collateral Batched-Continuous-Recheck Analysis")
    ...
    lines.append(
        ...
        + str(collateral["regression_correct_but_stability_recheck_unstable"])
    )
    ...
    for row in records:
        lines.append(
            "- "
            + f"{row['case_id']} ({row['batched_continuous_recheck_window_id']}#{row['batched_continuous_recheck_position']} / {row['real_prompt_anchor_id']}): "
    ...
    lines.append(
        "- stage_154_recoverable_real_continuous_pass_rate_reference: "
        + str(snapshots["stage_154"].get("recoverable_real_continuous_pass_rate"))
    )
    lines.append(
        "- stage_154_nonrecoverable_real_continuous_block_rate_reference: "
        + str(snapshots["stage_154"].get("nonrecoverable_real_continuous_block_rate"))
    )
    return "\n".join(lines) + "\n"
...
def _load_reference_snapshots(
    ...
    stage_154_summary = load_json(
        _required_file(stage_154_dir / "route_c_frozen_semantic_minimal_real_batched_continuous_regression_summary.json")
    )
    return {
        "stage_148": {
        ...
        "stage_154": {
            "recoverable_real_continuous_pass_rate": stage_154_summary.get("recoverable_real_continuous_pass_rate"),
            "normal_real_continuous_pass_rate": stage_154_summary.get("normal_real_continuous_pass_rate"),
            "nonrecoverable_real_continuous_block_rate": stage_154_summary.get("nonrecoverable_real_continuous_block_rate"),
            "all_cases_match_expected": stage_154_summary.get("all_cases_match_expected"),
            "path_level_drift_detected": stage_154_summary.get("path_level_drift", {}).get("path_level_drift_detected"),
            "parser_source_drift_detected": stage_154_summary.get("path_level_drift", {}).get("parser_source_drift_detected"),
        },
    }


def build_route_c_frozen_semantic_minimal_batched_continuous_stability_recheck(
    real_run_dir: Path,
    stage_148_dir: Path,
    stage_149_dir: Path,
    stage_150_dir: Path,
    ...
    stage_154_reference = _reference_by_case_id(_load_154_details(stage_154_dir))
    ...
    cases = _minimal_batched_continuous_stability_recheck_suite(
        ...
        stage_154_reference_by_case=stage_154_reference,
    )

    suite = {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "suite_name": "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_v1",
        "case_count": len(cases),
        "batched_continuous_recheck_window_ids": sorted({str(case["batched_continuous_recheck_window_id"]) for case in cases}),
        "real_prompt_anchor_ids": sorted({str(case["real_prompt_anchor_id"]) for case in cases}),
        "group_counts": dict(Counter(case["path_group"] for case in cases)),
    ...
    rules = {
        "summary_status": "PASS",
        "schema_version": SCHEMA_VERSION,
        "recoverable_batched_continuous_stability_recheck_criteria": [
        ...
        "normal_batched_continuous_stability_recheck_criteria": [
        ...
        "nonrecoverable_batched_continuous_stability_recheck_criteria": [
        ...
        "batched_continuous_stability_recheck_consistency_criteria": [
            "parser/gate/label-health/handoff semantics remain coherent",
            "impact scope stays local to recoverable boundary",
            "no new path-level drift or parser-source drift in batched continuous recheck chain",
            "no handoff contract violation or label-health anomaly",
            "no unexpected gate or logistic status fallback",
        ],
    }

    execution_root_dir = output_dir / "minimal_batched_continuous_stability_recheck_root"
    input_manifest = _materialize_batched_continuous_stability_recheck_inputs(
        cases=cases,
        real_raw_rows=real_raw_rows,
    ...
    dataset_result = build_benchmark_truth_leaning_dataset(
        ...
        / "execution_inputs"
        / "minimal_batched_continuous_stability_recheck_fusion_dataset.jsonl",
        labeled_illumination_raw_results_path=execution_root_dir
        / "execution_inputs"
        / "minimal_batched_continuous_stability_recheck_labeled_raw_results.jsonl",
        output_dir=dataset_dir,
        fusion_profile="route_c_frozen_semantic_minimal_batched_continuous_stability_recheck",
        run_id="route_c_frozen_semantic_minimal_batched_continuous_stability_recheck",
    ...
    write_json(output_dir / "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_suite.json", suite)
    write_json(output_dir / "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_rules.json", rules)
    write_json(output_dir / "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_summary.json", summary)
    write_jsonl(output_dir / "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_details.jsonl", records)
    (output_dir / "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_report.md").write_text(report, encoding="utf-8")
    ...
    write_json(
        output_dir / "config_snapshot.json",
        {
            ...
            "stage_154_dir": str(stage_154_dir.resolve()),
            "seed": seed,
            "label_threshold": label_threshold,
            "input_manifest_path": str(
                (execution_root_dir / "execution_inputs" / "batched_continuous_stability_recheck_input_manifest.json").resolve()
            ),
    ...
    return {
        ...
        "summary": summary,
        "output_paths": {
            "suite": str((output_dir / "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_suite.json").resolve()),
            "rules": str((output_dir / "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_rules.json").resolve()),
            "summary": str((output_dir / "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_summary.json").resolve()),
            "details": str((output_dir / "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_details.jsonl").resolve()),
            "report": str((output_dir / "route_c_frozen_semantic_minimal_batched_continuous_stability_recheck_report.md").resolve()),
