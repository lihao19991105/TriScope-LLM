#!/usr/bin/env python3
"""Build post anchor-aware route_c stability analysis artifacts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build post anchor-aware route_c stability analysis artifacts.")
    parser.add_argument(
...
def main() -> int:
    args = parse_args()
    from src.eval.post_route_c_anchor_stability_analysis import build_post_route_c_anchor_stability_analysis

    try:
        result = build_post_route_c_anchor_stability_analysis(
        ...
        print(f"TriScope-LLM post route_c anchor stability analysis failed: {exc}")
        print(f"Failure summary: {failure_path}")
        return 1

    print("TriScope-LLM post route_c anchor stability analysis complete")
