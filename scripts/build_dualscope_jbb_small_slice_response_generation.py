#!/usr/bin/env python3
"""CLI for bounded JBB small-slice response generation."""
...
from src.eval.dualscope_jbb_small_slice_response_generation import (  # noqa: E402
    DEFAULT_MATERIALIZATION_OUTPUT_DIR,
    ...
    SAFETY_MODE,
    build_jbb_small_slice_response_generation,
)


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run bounded safety-aware JBB small-slice generation.")
    ...
    parser.add_argument("--materialization-output-dir", type=Path, default=DEFAULT_MATERIALIZATION_OUTPUT_DIR)
...
def main() -> int:
    ...
    summary = build_jbb_small_slice_response_generation(
        source_jsonl=args.source_jsonl,
        plan_verdict=args.plan_verdict,
        materialization_verdict=args.materialization_verdict,
        materialization_output_dir=args.materialization_output_dir,
