#!/usr/bin/env python3
"""CLI for stage-198 route_c frozen semantic fourth-round real usage chain final recheck."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stage-197-dir", type=Path, default=Path("outputs/model_axis_1p5b_route_c_frozen_semantic_fourth_round_real_usage_pre_final_stability_recheck/default"))
...
def main() -> int:
    args = parse_args()
    from src.eval.route_c_frozen_semantic_fourth_round_real_usage_chain_final_recheck import build_route_c_frozen_semantic_fourth_round_real_usage_chain_final_recheck
    try:
        result = build_route_c_frozen_semantic_fourth_round_real_usage_chain_final_recheck(
            real_run_dir=args.real_run_dir,
            stage_195_dir=args.stage_195_dir,
            stage_196_dir=args.stage_196_dir,
            stage_197_dir=args.stage_197_dir,
        ...
        print(f"TriScope-LLM stage-198 failed: {exc}")
        print(f"Failure summary: {failure_path}")
        return 1
    print("stage-198 route_c frozen semantic fourth-round real usage chain final recheck artifacts written to:")
