#!/usr/bin/env python3
"""Build anchor-aware route_c execution artifacts for model-axis 1.5B."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build model-axis 1.5B anchor-aware route_c execution artifacts.")
    parser.add_argument(
...
def main() -> int:
    ...
    try:
        ...
        print(f"TriScope-LLM model-axis 1.5B route_c anchor execution failed: {exc}")
        print(f"Failure summary: {failure_path}")
        return 1

    print("TriScope-LLM model-axis 1.5B route_c anchor execution complete")
