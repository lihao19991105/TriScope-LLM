#!/usr/bin/env python3
"""Build the post-v6 symmetric comparison."""
...
from src.eval.post_v6_symmetric_comparison import build_post_v6_symmetric_comparison


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build the post-v6 symmetric comparison.")
    ...
    parser.add_argument("--route-b-v5-dir", type=Path, default=Path("outputs/rerun_route_b_on_labeled_split_v5/default"))
    parser.add_argument("--route-b-v6-dir", type=Path, default=Path("outputs/rerun_route_b_on_labeled_split_v6/default"))
    ...
    parser.add_argument("--route-c-v5-dir", type=Path, default=Path("outputs/rerun_route_c_on_labeled_split_v5/default"))
    parser.add_argument("--route-c-v6-dir", type=Path, default=Path("outputs/rerun_route_c_on_labeled_split_v6/default"))
    parser.add_argument("--post-v5-comparison-dir", type=Path, default=Path("outputs/post_v5_symmetric_comparison/default"))
    parser.add_argument("--post-v5-bootstrap-dir", type=Path, default=Path("outputs/post_v5_next_step_bootstrap/default"))
...
def main() -> int:
    ...
    try:
        result = build_post_v6_symmetric_comparison(
            ...
            route_b_v5_dir=args.route_b_v5_dir,
            route_b_v6_dir=args.route_b_v6_dir,
            ...
            route_c_v5_dir=args.route_c_v5_dir,
            route_c_v6_dir=args.route_c_v6_dir,
            post_v5_comparison_dir=args.post_v5_comparison_dir,
            post_v5_bootstrap_dir=args.post_v5_bootstrap_dir,
        ...
        print(f"TriScope-LLM post-v6 symmetric comparison failed: {exc}")
        print(f"Failure summary: {failure_path}")
        return 1

    print("TriScope-LLM post-v6 symmetric comparison complete")
