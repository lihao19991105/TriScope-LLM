#!/usr/bin/env python3
"""CLI for post-v5 real-experiment matrix analysis."""
...
from src.eval.post_v5_real_experiment_matrix_analysis import build_post_v5_real_experiment_matrix_analysis


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the post-v5 real-experiment matrix analysis.")
    parser.add_argument(
    ...
    parser.add_argument(
        "--next-matrix-analysis-recommendation-path",
        type=Path,
        default=Path("outputs/post_next_real_experiment_matrix_analysis/default/next_matrix_next_step_recommendation.json"),
    )
    parser.add_argument(
        "--post-next-matrix-bootstrap-summary-path",
        type=Path,
        default=Path("outputs/post_next_real_experiment_matrix_bootstrap/default/next_next_real_experiment_bootstrap_summary.json"),
    )
    parser.add_argument(
        "--post-next-matrix-dry-run-summary-path",
        type=Path,
        default=Path("outputs/post_next_real_experiment_matrix_dry_run/default/post_next_matrix_dry_run_summary.json"),
    )
    parser.add_argument(
        "--post-next-matrix-execution-run-summary-path",
        type=Path,
        default=Path("outputs/post_next_real_experiment_matrix_execution/default/post_next_matrix_execution_run_summary.json"),
    )
    parser.add_argument(
        "--post-next-matrix-analysis-recommendation-path",
        type=Path,
        default=Path("outputs/post_v3_real_experiment_matrix_analysis/default/post_next_matrix_next_step_recommendation.json"),
    )
    parser.add_argument(
        "--next-axis-matrix-bootstrap-summary-path",
        type=Path,
        default=Path("outputs/next_axis_real_experiment_matrix_bootstrap/default/next_axis_real_experiment_bootstrap_summary.json"),
    )
    parser.add_argument(
        "--next-axis-matrix-dry-run-summary-path",
        type=Path,
        default=Path("outputs/next_axis_real_experiment_matrix_dry_run/default/next_axis_matrix_dry_run_summary.json"),
    )
    parser.add_argument(
        "--next-axis-matrix-execution-run-summary-path",
        type=Path,
        default=Path("outputs/next_axis_real_experiment_matrix_execution/default/next_axis_matrix_execution_run_summary.json"),
    )
    parser.add_argument(
        "--next-axis-matrix-analysis-recommendation-path",
        type=Path,
        default=Path("outputs/post_v4_real_experiment_matrix_analysis/default/next_axis_matrix_next_step_recommendation.json"),
    )
    parser.add_argument(
        "--next-axis-after-v4-matrix-bootstrap-summary-path",
        type=Path,
    ...
    parser.add_argument(
        "--next-axis-after-v4-matrix-dry-run-summary-path",
        type=Path,
        default=Path("outputs/next_axis_after_v4_matrix_dry_run/default/next_axis_after_v4_matrix_dry_run_summary.json"),
    )
    parser.add_argument(
        "--next-axis-after-v4-matrix-execution-run-summary-path",
        type=Path,
        default=Path("outputs/next_axis_after_v4_matrix_execution/default/next_axis_after_v4_matrix_execution_run_summary.json"),
    )
    parser.add_argument(
        "--next-axis-after-v4-matrix-execution-metrics-path",
        type=Path,
        default=Path("outputs/next_axis_after_v4_matrix_execution/default/next_axis_after_v4_matrix_execution_metrics.json"),
    )
    parser.add_argument(
        "--next-axis-after-v4-matrix-fusion-summary-path",
        type=Path,
        default=Path("outputs/next_axis_after_v4_matrix_execution/default/next_axis_after_v4_matrix_fusion_summary.json"),
    )
    parser.add_argument(
        "--next-axis-after-v4-matrix-fusion-cell-candidate-summary-path",
        type=Path,
        default=Path("outputs/next_axis_after_v4_matrix_execution/default/next_axis_after_v4_matrix_fusion_cell_candidate_summary.json"),
    )
    parser.add_argument(
        "--next-axis-after-v4-matrix-fusion-cell-refined-summary-path",
        type=Path,
        default=Path("outputs/next_axis_after_v4_matrix_execution/default/next_axis_after_v4_matrix_fusion_cell_refined_summary.json"),
    )
    parser.add_argument(
        "--next-axis-after-v4-matrix-fusion-cell-refined-ablation-summary-path",
        type=Path,
        default=Path("outputs/next_axis_after_v4_matrix_execution/default/next_axis_after_v4_matrix_fusion_cell_refined_ablation_summary.json"),
    )
...
def main() -> int:
    args = parse_args()
    try:
        result = build_post_v5_real_experiment_matrix_analysis(
            ...
            next_axis_after_v4_matrix_execution_metrics_path=args.next_axis_after_v4_matrix_execution_metrics_path,
            next_axis_after_v4_matrix_fusion_summary_path=args.next_axis_after_v4_matrix_fusion_summary_path,
            next_axis_after_v4_matrix_fusion_cell_candidate_summary_path=args.next_axis_after_v4_matrix_fusion_cell_candidate_summary_path,
            next_axis_after_v4_matrix_fusion_cell_refined_summary_path=args.next_axis_after_v4_matrix_fusion_cell_refined_summary_path,
            next_axis_after_v4_matrix_fusion_cell_refined_ablation_summary_path=args.next_axis_after_v4_matrix_fusion_cell_refined_ablation_summary_path,
        ...
        print(f"TriScope-LLM post-v5 real-experiment matrix analysis failed: {exc}")
        return 1
    print("TriScope-LLM post-v5 real-experiment matrix analysis complete")
