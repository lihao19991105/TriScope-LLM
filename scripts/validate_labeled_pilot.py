#!/usr/bin/env python3
"""Validate labeled pilot bootstrap artifacts and optionally compare repeatability."""
...
from src.eval.labeled_pilot_checks import compare_labeled_pilot_runs, validate_labeled_pilot


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Validate labeled pilot bootstrap artifacts and optionally compare repeatability.")
...
def main() -> int:
    ...
    print("TriScope-LLM labeled pilot validation complete")
