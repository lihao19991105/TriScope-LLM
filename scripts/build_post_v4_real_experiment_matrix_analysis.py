#!/usr/bin/env python3
"""CLI for post-v4 real-experiment matrix analysis."""
...
from src.eval.post_v4_real_experiment_matrix_analysis import (
    build_post_v4_real_experiment_matrix_analysis,
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the post-v4 real-experiment matrix analysis.")
    parser.add_argument(
    ...
    parser.add_argument(
        "--next-axis-matrix-execution-metrics-path",
        type=Path,
        default=Path("outputs/next_axis_real_experiment_matrix_execution/default/next_axis_matrix_execution_metrics.json"),
    )
    parser.add_argument(
        "--next-axis-matrix-fusion-summary-path",
        type=Path,
        default=Path("outputs/next_axis_real_experiment_matrix_execution/default/next_axis_matrix_fusion_summary.json"),
    )
    parser.add_argument(
        "--next-axis-matrix-fusion-cell-candidate-summary-path",
        type=Path,
        default=Path("outputs/next_axis_real_experiment_matrix_execution/default/next_axis_matrix_fusion_cell_candidate_summary.json"),
    )
    parser.add_argument(
        "--next-axis-matrix-fusion-cell-refined-summary-path",
        type=Path,
        default=Path("outputs/next_axis_real_experiment_matrix_execution/default/next_axis_matrix_fusion_cell_refined_summary.json"),
    )
...
def main() -> int:
    args = parse_args()
    try:
        result = build_post_v4_real_experiment_matrix_analysis(
            ...
            next_axis_matrix_execution_metrics_path=args.next_axis_matrix_execution_metrics_path,
            next_axis_matrix_fusion_summary_path=args.next_axis_matrix_fusion_summary_path,
            next_axis_matrix_fusion_cell_candidate_summary_path=args.next_axis_matrix_fusion_cell_candidate_summary_path,
            next_axis_matrix_fusion_cell_refined_summary_path=args.next_axis_matrix_fusion_cell_refined_summary_path,
        ...
        print(f"TriScope-LLM post-v4 real-experiment matrix analysis failed: {exc}")
        return 1
    print("TriScope-LLM post-v4 real-experiment matrix analysis complete")
