#!/usr/bin/env python3
"""Build bounded Qwen2.5-7B Alpaca main-slice metric artifacts."""
...
from src.eval.dualscope_qwen2p5_7b_alpaca_main_slice_metric_computation import (  # noqa: E402
    build_qwen2p5_7b_alpaca_main_slice_metric_computation,
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Compute bounded Qwen2.5-7B Alpaca main-slice metrics only from aligned labels, "
    ...
    parser.add_argument(
        ...
        help="Bounded Alpaca main-slice response-generation artifact directory.",
    )
    parser.add_argument(
        "--score-dir",
        type=Path,
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("outputs/dualscope_qwen2p5_7b_alpaca_main_slice_metric_computation/default"),
    ...
    parser.add_argument(
        ...
        default=Path(
            ".reports/dualscope_task_verdicts/"
            "dualscope-qwen2p5-7b-alpaca-main-slice-metric-computation.json"
        ),
...
def main() -> int:
    ...
    summary = build_qwen2p5_7b_alpaca_main_slice_metric_computation(
