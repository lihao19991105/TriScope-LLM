#!/usr/bin/env python3
"""Build the post-v5 symmetric comparison."""
...
from src.eval.post_v5_symmetric_comparison import build_post_v5_symmetric_comparison


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build the post-v5 symmetric comparison.")
    ...
    parser.add_argument("--post-v4-comparison-dir", type=Path, default=Path("outputs/post_v4_symmetric_comparison/default"))
    parser.add_argument("--post-v4-bootstrap-dir", type=Path, default=Path("outputs/post_v4_next_step_bootstrap/default"))
...
def main() -> int:
    ...
    try:
        result = build_post_v5_symmetric_comparison(
            ...
            post_v4_comparison_dir=args.post_v4_comparison_dir,
            post_v4_bootstrap_dir=args.post_v4_bootstrap_dir,
        ...
        print(f"TriScope-LLM post-v5 symmetric comparison failed: {exc}")
        print(f"Failure summary: {failure_path}")
        return 1

    print("TriScope-LLM post-v5 symmetric comparison complete")
