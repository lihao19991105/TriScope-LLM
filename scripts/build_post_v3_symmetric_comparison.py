#!/usr/bin/env python3
"""Build the post-v3 symmetric comparison."""
...
from src.eval.post_v3_symmetric_comparison import build_post_v3_symmetric_comparison


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build the post-v3 symmetric comparison.")
    ...
    parser.add_argument(
        "--larger-route-c-dir",
        type=Path,
        default=Path("outputs/rerun_route_c_on_larger_split/default"),
    )
    ...
    parser.add_argument(
        "--post-v2-comparison-dir",
        type=Path,
        default=Path("outputs/post_v2_symmetric_comparison/default"),
    )
    parser.add_argument(
        "--post-v2-bootstrap-dir",
        type=Path,
        default=Path("outputs/post_v2_next_step_bootstrap/default"),
    )
...
def main() -> int:
    ...
    try:
        result = build_post_v3_symmetric_comparison(
            ...
            post_v2_comparison_dir=args.post_v2_comparison_dir,
            post_v2_bootstrap_dir=args.post_v2_bootstrap_dir,
        ...
        print(f"TriScope-LLM post-v3 symmetric comparison failed: {exc}")
        print(f"Failure summary: {failure_path}")
        return 1

    print("TriScope-LLM post-v3 symmetric comparison complete")
