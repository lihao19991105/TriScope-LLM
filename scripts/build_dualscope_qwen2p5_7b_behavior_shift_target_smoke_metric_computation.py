#!/usr/bin/env python3
"""Build bounded Qwen2.5-7B behavior-shift target smoke metric artifacts."""
...
from src.eval.dualscope_qwen2p5_7b_behavior_shift_target_smoke_metric_computation import (  # noqa: E402
    build_qwen2p5_7b_behavior_shift_target_smoke_metric_computation,
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Compute bounded Qwen2.5-7B behavior-shift target smoke metrics only from aligned labels, "
    ...
    parser.add_argument(
        ...
        help="Bounded behavior-shift target smoke response-generation artifact directory.",
    )
    parser.add_argument(
        "--score-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "dualscope-qwen2p5-7b-behavior-shift-target-smoke-response-generation.json"
        ),
    ...
    parser.add_argument(
        ...
        default=Path(
            ".reports/dualscope_task_verdicts/"
            "dualscope-qwen2p5-7b-behavior-shift-target-smoke-response-generation-repair.json"
        ),
    ...
    parser.add_argument(
        ...
        default=Path(
            ".reports/dualscope_task_verdicts/"
            "dualscope-qwen2p5-7b-behavior-shift-target-smoke-metric-computation.json"
        ),
...
def main() -> int:
    ...
    summary = build_qwen2p5_7b_behavior_shift_target_smoke_metric_computation(
