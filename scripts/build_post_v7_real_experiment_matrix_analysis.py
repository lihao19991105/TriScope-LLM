#!/usr/bin/env python3
"""CLI for post-v7 real-experiment matrix analysis."""
...
from src.eval.post_v7_real_experiment_matrix_analysis import build_post_v7_real_experiment_matrix_analysis


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the post-v7 real-experiment matrix analysis.")
    ...
    parser.add_argument("--next-axis-after-v6-matrix-execution-metrics-path", type=Path, default=Path("outputs/next_axis_after_v6_matrix_execution/default/next_axis_after_v6_matrix_execution_metrics.json"))
    parser.add_argument("--next-axis-after-v6-matrix-fusion-summary-path", type=Path, default=Path("outputs/next_axis_after_v6_matrix_execution/default/next_axis_after_v6_matrix_fusion_summary.json"))
    parser.add_argument("--next-axis-after-v6-matrix-fusion-cell-candidate-summary-path", type=Path, default=Path("outputs/next_axis_after_v6_matrix_execution/default/next_axis_after_v6_matrix_fusion_cell_candidate_summary.json"))
    parser.add_argument("--next-axis-after-v6-matrix-fusion-cell-refined-summary-path", type=Path, default=Path("outputs/next_axis_after_v6_matrix_execution/default/next_axis_after_v6_matrix_fusion_cell_refined_summary.json"))
    parser.add_argument("--next-axis-after-v6-matrix-fusion-cell-refined-ablation-summary-path", type=Path, default=Path("outputs/next_axis_after_v6_matrix_execution/default/next_axis_after_v6_matrix_fusion_cell_refined_ablation_summary.json"))
    parser.add_argument("--next-axis-after-v6-matrix-fusion-cell-refined-support-sweep-summary-path", type=Path, default=Path("outputs/next_axis_after_v6_matrix_execution/default/next_axis_after_v6_matrix_fusion_cell_refined_support_sweep_summary.json"))
    parser.add_argument("--next-axis-after-v6-matrix-fusion-cell-refined-support-ablation-summary-path", type=Path, default=Path("outputs/next_axis_after_v6_matrix_execution/default/next_axis_after_v6_matrix_fusion_cell_refined_support_ablation_summary.json"))
...
def main() -> int:
    args = parse_args()
    try:
        result = build_post_v7_real_experiment_matrix_analysis(
            ...
            next_axis_after_v6_matrix_execution_metrics_path=args.next_axis_after_v6_matrix_execution_metrics_path,
            next_axis_after_v6_matrix_fusion_summary_path=args.next_axis_after_v6_matrix_fusion_summary_path,
            next_axis_after_v6_matrix_fusion_cell_candidate_summary_path=args.next_axis_after_v6_matrix_fusion_cell_candidate_summary_path,
            next_axis_after_v6_matrix_fusion_cell_refined_summary_path=args.next_axis_after_v6_matrix_fusion_cell_refined_summary_path,
            next_axis_after_v6_matrix_fusion_cell_refined_ablation_summary_path=args.next_axis_after_v6_matrix_fusion_cell_refined_ablation_summary_path,
            next_axis_after_v6_matrix_fusion_cell_refined_support_sweep_summary_path=args.next_axis_after_v6_matrix_fusion_cell_refined_support_sweep_summary_path,
            next_axis_after_v6_matrix_fusion_cell_refined_support_ablation_summary_path=args.next_axis_after_v6_matrix_fusion_cell_refined_support_ablation_summary_path,
        ...
        print(f"TriScope-LLM post-v7 real-experiment matrix analysis failed: {exc}")
        return 1
    print("TriScope-LLM post-v7 real-experiment matrix analysis complete")
