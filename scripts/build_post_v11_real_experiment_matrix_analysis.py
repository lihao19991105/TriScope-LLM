#!/usr/bin/env python3
"""CLI for post-v11 real-experiment matrix analysis."""
...
from src.eval.post_v11_real_experiment_matrix_analysis import build_post_v11_real_experiment_matrix_analysis


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the post-v11 real-experiment matrix analysis.")
    ...
    parser.add_argument("--next-axis-after-v7-matrix-analysis-recommendation-path", type=Path, default=Path("outputs/post_v8_real_experiment_matrix_analysis/default/next_axis_after_v7_matrix_next_step_recommendation.json"))
    parser.add_argument("--next-axis-after-v8-matrix-bootstrap-summary-path", type=Path, default=Path("outputs/next_axis_after_v8_matrix_bootstrap/default/next_axis_after_v8_bootstrap_summary.json"))
    parser.add_argument("--next-axis-after-v8-matrix-dry-run-summary-path", type=Path, default=Path("outputs/next_axis_after_v8_matrix_dry_run/default/next_axis_after_v8_matrix_dry_run_summary.json"))
    parser.add_argument("--next-axis-after-v8-matrix-execution-run-summary-path", type=Path, default=Path("outputs/next_axis_after_v8_matrix_execution/default/next_axis_after_v8_matrix_execution_run_summary.json"))
    parser.add_argument("--next-axis-after-v8-matrix-analysis-recommendation-path", type=Path, default=Path("outputs/post_v9_real_experiment_matrix_analysis/default/next_axis_after_v8_matrix_next_step_recommendation.json"))
    parser.add_argument("--next-axis-after-v9-matrix-bootstrap-summary-path", type=Path, default=Path("outputs/next_axis_after_v9_matrix_bootstrap/default/next_axis_after_v9_bootstrap_summary.json"))
    parser.add_argument("--next-axis-after-v9-matrix-dry-run-summary-path", type=Path, default=Path("outputs/next_axis_after_v9_matrix_dry_run/default/next_axis_after_v9_matrix_dry_run_summary.json"))
    parser.add_argument("--next-axis-after-v9-matrix-execution-run-summary-path", type=Path, default=Path("outputs/next_axis_after_v9_matrix_execution/default/next_axis_after_v9_matrix_execution_run_summary.json"))
    parser.add_argument("--next-axis-after-v9-matrix-analysis-recommendation-path", type=Path, default=Path("outputs/post_v10_real_experiment_matrix_analysis/default/next_axis_after_v9_matrix_next_step_recommendation.json"))
    parser.add_argument("--next-axis-after-v10-matrix-bootstrap-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_bootstrap/default/next_axis_after_v10_bootstrap_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-dry-run-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_dry_run/default/next_axis_after_v10_matrix_dry_run_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-execution-run-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_execution_run_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-execution-metrics-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_execution_metrics.json"))
    parser.add_argument("--next-axis-after-v10-matrix-fusion-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_fusion_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-fusion-cell-candidate-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_fusion_cell_candidate_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-fusion-cell-refined-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_fusion_cell_refined_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-fusion-cell-refined-ablation-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_fusion_cell_refined_ablation_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-fusion-cell-refined-support-sweep-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_fusion_cell_refined_support_sweep_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-fusion-cell-refined-support-ablation-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-fusion-cell-refined-support-ablation-sweep-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_sweep_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-fusion-cell-refined-support-ablation-floor-probe-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_floor_probe_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-fusion-cell-refined-support-ablation-floor-stress-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_floor_stress_summary.json"))
    parser.add_argument("--next-axis-after-v10-matrix-fusion-cell-refined-support-ablation-floor-stress-sweep-summary-path", type=Path, default=Path("outputs/next_axis_after_v10_matrix_execution/default/next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_floor_stress_sweep_summary.json"))
...
def main() -> int:
    args = parse_args()
    try:
        result = build_post_v11_real_experiment_matrix_analysis(
            ...
            next_axis_after_v7_matrix_analysis_recommendation_path=args.next_axis_after_v7_matrix_analysis_recommendation_path,
            next_axis_after_v8_matrix_bootstrap_summary_path=args.next_axis_after_v8_matrix_bootstrap_summary_path,
            next_axis_after_v8_matrix_dry_run_summary_path=args.next_axis_after_v8_matrix_dry_run_summary_path,
            next_axis_after_v8_matrix_execution_run_summary_path=args.next_axis_after_v8_matrix_execution_run_summary_path,
            next_axis_after_v8_matrix_analysis_recommendation_path=args.next_axis_after_v8_matrix_analysis_recommendation_path,
            next_axis_after_v9_matrix_bootstrap_summary_path=args.next_axis_after_v9_matrix_bootstrap_summary_path,
            next_axis_after_v9_matrix_dry_run_summary_path=args.next_axis_after_v9_matrix_dry_run_summary_path,
            next_axis_after_v9_matrix_execution_run_summary_path=args.next_axis_after_v9_matrix_execution_run_summary_path,
            next_axis_after_v9_matrix_analysis_recommendation_path=args.next_axis_after_v9_matrix_analysis_recommendation_path,
            next_axis_after_v10_matrix_bootstrap_summary_path=args.next_axis_after_v10_matrix_bootstrap_summary_path,
            next_axis_after_v10_matrix_dry_run_summary_path=args.next_axis_after_v10_matrix_dry_run_summary_path,
            next_axis_after_v10_matrix_execution_run_summary_path=args.next_axis_after_v10_matrix_execution_run_summary_path,
            next_axis_after_v10_matrix_execution_metrics_path=args.next_axis_after_v10_matrix_execution_metrics_path,
            next_axis_after_v10_matrix_fusion_summary_path=args.next_axis_after_v10_matrix_fusion_summary_path,
            next_axis_after_v10_matrix_fusion_cell_candidate_summary_path=args.next_axis_after_v10_matrix_fusion_cell_candidate_summary_path,
            next_axis_after_v10_matrix_fusion_cell_refined_summary_path=args.next_axis_after_v10_matrix_fusion_cell_refined_summary_path,
            next_axis_after_v10_matrix_fusion_cell_refined_ablation_summary_path=args.next_axis_after_v10_matrix_fusion_cell_refined_ablation_summary_path,
            next_axis_after_v10_matrix_fusion_cell_refined_support_sweep_summary_path=args.next_axis_after_v10_matrix_fusion_cell_refined_support_sweep_summary_path,
            next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_summary_path=args.next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_summary_path,
            next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_sweep_summary_path=args.next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_sweep_summary_path,
            next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_floor_probe_summary_path=args.next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_floor_probe_summary_path,
            next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_floor_stress_summary_path=args.next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_floor_stress_summary_path,
            next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_floor_stress_sweep_summary_path=args.next_axis_after_v10_matrix_fusion_cell_refined_support_ablation_floor_stress_sweep_summary_path,
        ...
        print(f"TriScope-LLM post-v11 real-experiment matrix analysis failed: {exc}")
        return 1
    print("TriScope-LLM post-v11 real-experiment matrix analysis complete")
