#!/usr/bin/env python3
"""Build route_c refined candidate execution artifacts for model-axis 1.5B."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build model-axis 1.5B route_c refined execution artifacts.")
    parser.add_argument(
...
def main() -> int:
    args = parse_args()
    from src.eval.model_axis_1p5b_route_c_refined_execution import build_model_axis_1p5b_route_c_refined_execution
    ...
    try:
        ...
        print(f"TriScope-LLM model-axis 1.5B route_c refined execution failed: {exc}")
        print(f"Failure summary: {failure_path}")
        return 1

    print("TriScope-LLM model-axis 1.5B route_c refined execution complete")
