#!/usr/bin/env python3
"""Build post deepened route_c analysis artifacts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build post deepened route_c analysis artifacts.")
    parser.add_argument(
    ...
    parser.add_argument(
        "--route-c-deepened-stability-dir",
        type=Path,
        default=Path("outputs/model_axis_1p5b_route_c_deepened_stability/default"),
    )
...
def main() -> int:
    args = parse_args()
    from src.eval.post_route_c_deepened_analysis import build_post_route_c_deepened_analysis

    try:
        result = build_post_route_c_deepened_analysis(
            ...
            route_c_deepened_stability_dir=args.route_c_deepened_stability_dir,
        ...
        print(f"TriScope-LLM post deepened route_c analysis failed: {exc}")
        print(f"Failure summary: {failure_path}")
        return 1

    print("TriScope-LLM post deepened route_c analysis complete")
